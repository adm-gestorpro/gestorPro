...
def consulta_estoque(produto, loja):
    consulta_api = f'/comercial/estoques'
    ...
    if dados:
        for dado in dados:
            estoque = {'cod_produto': dado['produtoKey'], 'cod_loja': dado['lojaKey'], 'estoque_disponivel': dado['saldoDisponivel']}
            return estoque